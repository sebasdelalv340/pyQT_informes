...
class ReservaPDF(FPDF):
    ...
    def create_pdf(self):
        ...
        self.cell(40, 10, 'Email cliente', 1, 0, 'C')
        self.cell(40, 10, 'Nª habitacion', 1, 0, 'C')
        self.cell(40, 10, 'Checkin', 1, 0, 'C')
        self.cell(60, 10, 'Checkout', 1, 0, 'C')
        self.cell(60, 10, 'Estado', 1, 0, 'C')
